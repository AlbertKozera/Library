...
public class DodajCzytelnik {
    ...
    public DodajCzytelnik (Integer idOsoba, String Imie, String Nazwisko, String login, String haslo, String email, String telefon,  String Nr_kartyBib){  //Konstruktor
